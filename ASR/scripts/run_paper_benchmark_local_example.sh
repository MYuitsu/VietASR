...
# Real ASR checkpoint found on this machine.
...
cd /home/nguyenthaiduy277/VietASR-1/ASR
export GIGASPEECH2_CUTS="../SSL/data/fbank/vietASR_cuts_gigaspeech2.jsonl.gz"
export COMMONVOICE_CUTS="../SSL/data/fbank/vietASR_cuts_commonvoice.jsonl.gz"
export FLEURS_CUTS="../SSL/data/fbank/vietASR_cuts_fleurs.jsonl.gz"
